      ...
      <main className="flex-1 py-16 sm:py-24">
        <div className="container">
          ...
          >
            ...
            <motion.p variants={itemVariants}>Please read these Terms of Service ("Terms") carefully before using the services offered by Global Trusera Holdings ("Global Trusera", "we", "us", "our"). By using our services, you agree to be bound by these Terms.</motion.p>
            ...
            <motion.p variants={itemVariants}>The service and its original content, features, and functionality are and will remain the exclusive property of Global Trusera Holdings and its licensors. Our trademarks may not be used in connection with any product or service without the prior written consent of Global Trusera Holdings.</motion.p>
            ...
            <motion.p variants={itemVariants}>In no event shall Global Trusera Holdings, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses.</motion.p>
            ...
            <motion.p variants={itemVariants}>If you have any questions about these Terms, please contact us at <a href="mailto:info@globaltruseraholdings.com">info@globaltruseraholdings.com</a>.</motion.p>
          </motion.article>
        </div>
      </main>
      <Footer />
